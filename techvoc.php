...
<body class="courses-page">
      ...
      <nav class="breadcrumbs">
        <div class="container">
          <ol>
            ...
            <li class="current">Felta TechVoc</li>
          </ol>
        </div>
      </nav>
    </div><!-- End Page Title -->
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="100">
            <div class="course-item">
              <img src="assets/pics/tesda.png" class="img-fluid" alt="...">
              <div class="course-content">
                <div class="d-flex justify-content-between align-items-center mb-3">

                </div>

                <h3><a href="tesda.php">TESDA Accredited Programs</a></h3>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-md-0" data-aos="zoom-in" data-aos-delay="200">
            <div class="course-item">
              <img src="assets/pics/feltatechvoc.png" class="img-fluid" alt="...">
              <div class="course-content">
                <div class="d-flex justify-content-between align-items-center mb-3">

                </div>
                <h3><a href="robotics.php">Robotics</a></h3>
                <p class="description">Professional Developments Training for Teachers</p>
  ...
  <footer id="footer" class="footer position-relative light-background">
    ...
    <div class="container copyright text-center mt-4">
      <p>© <span>Copyright</span> <strong class="px-1 sitename">2025 Felta Multimedia Inc.</strong> <span>All Rights Reserved</span></p>
    </div>
