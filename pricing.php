...
<body class="pricing-page">
      ...
      <div class="container">
        <div class="row justify-content-center">
          ...
          <div class="col-12 col-sm-10 col-lg-8 mb-5">
            <h2 class="text-center mb-4">iCreate  FAQs</h2>
              ...
              <div class="card border-0 wow fadeInUp" data-wow-delay="0.1s">
                <div class="card-header" id="icreateHeadingOne">
                  <h6 class="mb-0" data-bs-toggle="collapse" data-bs-target="#icreateCollapseOne" aria-expanded="false" aria-controls="icreateCollapseOne">
                    1. What is iCreate  Manila?<span class="lni-chevron-up"></span></h6>
                </div>
                <div class="collapse" id="icreateCollapseOne" aria-labelledby="icreateHeadingOne" data-bs-parent="#icreateFaqAccordion">
                  <div class="card-body">
                    <p>iCreate  Manila is a Robotics Training Center that aims to promote Robotics for all. We are committed to making robotics education accessible to everyone, helping to inspire future innovators through hands-on learning and creative exploration.</p>
                  </div>
                </div>
              </div>
              <!-- FAQ 2 -->
              ...
              <div class="card border-0 wow fadeInUp" data-wow-delay="0.35s">
                ...
                <div class="collapse" id="icreateCollapseSix" aria-labelledby="icreateHeadingSix" data-bs-parent="#icreateFaqAccordion">
                  <div class="card-body">
                    ...
                    <ul>
                      <li>Send us a DM via our <a href="https://www.facebook.com/icreatemanila" target="_blank">iCreate  Manila Facebook Page</a></li>
  ...
  <style>
    ...
    /* Add margin between FAQ sections */
    .col-12.col-sm-10.col-lg-8.mb-5 {
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    // Handle iCreate  FAQs with smooth animation
