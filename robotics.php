    ...
    <section id="courses" class="courses section">
      ...
      <div class="container">
        ...
        <div class="row">
            ...
            <div class="course-item">
              ...
              <div class="course-content">
                <div class="d-flex justify-content-between align-items-center mb-3">
                  <p class="category">Felta TechVoc Academy</p>
                </div>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-lg-0" data-aos="zoom-in" data-aos-delay="300">
            <div class="course-item">
              <img src="assets/pics/dobot.png" class="img-fluid" alt="...">
              <div class="course-content">
                <div class="d-flex justify-content-between align-items-center mb-3">
                  <p class="category">Felta TechVoc Academy</p>
                </div>

                <h3><a href="course-details.php">Dobot Arm</a></h3>
                <p class="description">The DOBOT Robotic Arm is a versatile, high-precision tool designed for education, automation, and innovation. With features like 3D printing, 
                  laser engraving, and programmable movement, it helps students and professionals explore robotics, AI, and Industry 4.0 technologies. Easy to use and highly adaptable, 
                  DOBOT brings real-world automation into the classroom and lab.</p>
